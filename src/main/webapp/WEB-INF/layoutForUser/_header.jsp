		...
		<div class="container">
			<div class="ht-left">
				<div class="mail-service">
					<i class=" fa fa-envelope"></i> luanmvps21521@fpt.edu.vn
				</div>
				<div class="phone-service">
					<i class=" fa fa-phone"></i> +0384743824
				</div>
			</div>
			<div class="ht-right">
				...
				<c:if test="${!isLogin}">
					...
					<div class="top-social">
						<a href="/home/register"><i class="fa fa-plus pr-1"></i>Đăng Ký</a>
					</div>
				</c:if>
				<c:if test="${isLogin}">
					<c:if test="${admin}">
		...
		<div class="inner-header">
			<div class="row">
				<div class="col-lg-2 col-md-2">
					<div class="logo">
						<a href="index"> <img src="/forUser/img/logo1.jpg" alt="" >
						</a>
					</div>
				</div>
